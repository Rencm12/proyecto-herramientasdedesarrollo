...
function Card({ producto }) {
  ...
  const { imagen, titulo, consola, descripcion, precio, exclusivo, limitada, stock } = producto;
    ...
    >
      ...
      <div className="p-4">
        ...
        <button
          ...
          className="
            w-full mt-4 bg-[#00ffc3] text-black
            py-2 rounded-lg font-bold transition hover:bg-[#00d7aa]
          "
        >
          Agregar al carrito
        </button>
        ...
        <button
          ...
          className="
            w-full mt-3 border border-[#00ffc3] text-[#00ffc3]
            py-2 rounded-lg font-bold hover:bg-[#00ffc3] hover:text-black transition
          "
        >
          Ver más
        </button>
        ...
        >
          ...
          <div className="p-6">
            ...
            <button
              ...
              disabled={stock === 0}
              className="
                mt-6 w-full bg-[#00ffc3] text-black
                py-3 rounded-xl font-bold hover:bg-[#00d9a8] transition
                disabled:opacity-40 disabled:cursor-not-allowed disabled:hover:bg-[#00ffc3]
              "
            >
